...
if( isset( $_GET['username'] ) AND $_GET['username'] != '' ):
    ...
    $consumerkey = "mLlDrb13NXGUiGPoSbg83mLVT";
    $consumersecret = "XDR97PASVvXpcSVJxjuUfFiZtapty85h7wM40c4qcp9r46qDaS";
    $accesstoken = "333208873-SNAjp0tJ8pRdHuvlvmrrhRRT6psxGUsgpfP9ouTF";
    $accesstokensecret = "cc2RZx4i6wN4vqRWdR1KnbF9ntAXACSQq6hKJhPaEu3cL";
